...
# Spider
class FincaraizCitiesScrapper(scrapy.Spider):
    name = 'fincaraiz_cities'
    allowed_domains = ['www.fincaraiz.com.co']
    custom_settings = { 
        'FEEDS': {'data_cities_fincaraiz.csv': {'format': 'csv', 'overwrite': True}} 
    } 
    ...
    def start_requests(self): 
        with open('cities.csv', 'r', encoding="utf8") as cities:
            for line in csv.reader(cities):
                ...
                # Url
                url = "https://www.fincaraiz.com.co/venta/"+location   
...
process.crawl(FincaraizCitiesScrapper)
process.start()
