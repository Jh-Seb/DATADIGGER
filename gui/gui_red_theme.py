...
returnicon = customtkinter.CTkImage(
    light_image=Image.open(r'assets\red_theme\returnimage.png'),
    dark_image=Image.open(r'assets\red_theme\returnimage.png'),
    size = (60,60)
)
...
class Dynamic_Scraper(BaseScreen):
    def __init__(self, parent):
        ...
        self.finca_button.place(relx=0.6, rely=0.5, anchor="center")
        ...
        self.proper_button.place(relx=0.6, rely=0.5, anchor="center")
