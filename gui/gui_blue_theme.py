...
# --------- PALETA DE COLORES CYBERPUNK (AZUL) ---------
COLOR_BG               = "#0b0c10"  # Fondo principal
COLOR_BUTTON           = "#1f2833"  # Fondo de botones
COLOR_BORDER           = "#45a29e"  # Contorno de botones
COLOR_HOVER            = "#30d4cc"  # Color hover de botones
COLOR_TITLE            = "#00ffff"  # Color de los títulos
COLOR_TEXT             = "#c5c6c7"  # Texto general
COLOR_FRAME            = "#1f2833"  # Fondo de frames "oscuros"
COLOR_HIGHLIGHT_FRAME  = "#66fcf1"  # Fondo de frames "destacados"
COLOR_ERROR_TEXT       = "red"      # Texto para mensajes de error


# Definir Imágenes (una sola vez)
logo = customtkinter.CTkImage(
    light_image=Image.open(r'assets\blue_theme\logo2.png'),
    dark_image=Image.open(r'assets\blue_theme\logo2.png'),
    size=(50, 50)
)
bgimage = customtkinter.CTkImage(
    light_image=Image.open(r'assets\blue_theme\bgimage.png'),
    dark_image=Image.open(r'assets\blue_theme\bgimage.png'),
    size=(1381.25, 1056)
)
questionicon = customtkinter.CTkImage(
    light_image=Image.open(r'assets\blue_theme\Questionicon.png'),
    dark_image=Image.open(r'assets\blue_theme\Questionicon.png'),
    size=(60, 60)
)
configicon = customtkinter.CTkImage(
    light_image=Image.open(r'assets\blue_theme\configicon.png'),
    dark_image=Image.open(r'assets\blue_theme\configicon.png'),
    size=(60, 60)
)
homeicon = customtkinter.CTkImage(
    light_image=Image.open(r'assets\blue_theme\homeicon.png'),
...
# Ventana principal
class APPGUIBLUE(customtkinter.CTk):
    def __init__(self):
        super().__init__()
...
class Static_Scraper(BaseScreen):
    ...
    def show_wiki_frame(self):
        ...
        self.wiki_title_label = customtkinter.CTkLabel(
            ...
            text=self.title,
            font=("Segoe UI Black", 40, "bold"),
            text_color=COLOR_BG,  # Para contraste sobre el frame claro/hover
            width=300,
            height=60
        )
